...
md"""
!!! danger "Trajectories around a profile"

	_by [Jean-François Barthélémy](https://jfbarthelemy.github.io/)_

	This tutorial provides tool to visualize 2D trajectories of incompressible fluid around a profile.
"""

# ╔═╡ 095e36ea-0747-4b70-829a-bce881f04660
md"""
# Trajectories around a profile

#### Hypotheses
- Perfect incompressible and irrotationnal fluid
- Steady state
- Remote velocity $\underline{U}=U\underline{e}_x$

#### Cyclique flow around a cylinder
- Complex potential $F(ζ)=U\,\left(ζ+\frac{R^2}{ζ}\right)-\frac{i\,m}{2π}\log{\frac{ζ}{R}}$
- Complex velocity $W(ζ)=F'(ζ)=U_x-i\,U_y=U\,\left(1-\frac{R^2}{ζ^2}\right)-\frac{i\,m}{2πζ}$

#### Conformal mapping
- Translation/rotation $T: ζ ↦ Z=b+ζ\,e^{iα}$ with $b=c-R\,e^{-iβ}$
- Joukovski $J: Z ↦ z=Z+\frac{c^2}{Z}$
- Rotation $R: z ↦ z\,e^{-iα}$
- Mapping $f(z)=F(ζ)$ with $z=h(ζ)$ and $h=R∘J∘T$
- Singular point such that $h'(ζ^*)=0$ given by $Z^*=c$ since $J'(c)=0$ i.e. $ζ^*=R\,e^{-i(α+β)}$
- Kutta-Joukovski condition given by $F'(ζ^*)=0$ i.e. $m=-4πRU\sin{(α+β)}$
...
\end{equation*}
```
- Return in the "$ζ$" plane: let $z(t)=h(ζ(t))$ so $\dot{ζ}=\frac{\dot{z}}{h'(ζ)}$, which gives, thanks to $f'(z)=\frac{F'(ζ)}{h'(ζ)}$, the new system
```math
\begin{equation*}
\left\{
\begin{array}{rcl}
\dot{ζ}&=&\frac{\overline{F'(ζ)}}{\lvert h'(ζ) \rvert^2}\\
ζ(0)&=&ζ_0=h^{-1}(z_0)
\end{array}
\right.
\end{equation*}
...
# ╔═╡ 2e4ab758-1c7e-483c-a37f-0f01f0e7987e
...
git-tree-sha1 = "fb141400f0d184a57cd072aaf6090386df3889dd"
...
git-tree-sha1 = "61174d2468581911ce394e948ff26ca820e285ba"
...
git-tree-sha1 = "72c91ad0922d5bef1362f71707f7731ad66e387d"
...
[[deps.LightOSM]]
deps = ["DataStructures", "Graphs", "HTTP", "JSON", "LightXML", "MetaGraphs", "NearestNeighbors", "Parameters", "SimpleWeightedGraphs", "SparseArrays", "StaticGraphs", "Statistics"]
git-tree-sha1 = "996b8038d66eb675278ce26bf7f68c29eaf161cb"
...
git-tree-sha1 = "c9fda092ec033dd51e2ec4af7cc1f890be683a7f"
...
git-tree-sha1 = "e7542e935fdb859249f1871815e49d388ab90823"
